...
public class CameraConnectionFragment extends Fragment
{
  ...
  private final CameraDevice.StateCallback stateCallback =
      new CameraDevice.StateCallback() {
        ...
        public void onOpened(final CameraDevice cd) {
          ...
          cameraDevice = cd;
          createCameraPreviewSession(CaptureRequest.FLASH_MODE_OFF);
        }
  ...
  private void setUpCameraOutputs() {
    ...
    try {
      ...
      ErrorDialog.newInstance(getString(R.string.common_camera_error))
          .show(getChildFragmentManager(), FRAGMENT_DIALOG);
      throw new RuntimeException(getString(R.string.common_camera_error));
    }
   ...
   */
  private void createCameraPreviewSession(int flashMode) {
    try {
  ...
  {
    createCameraPreviewSession(CaptureRequest.FLASH_MODE_TORCH);
  }
}
